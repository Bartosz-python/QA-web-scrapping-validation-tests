...
from scraper.scraper import Book
...
class Save:
    ...
    def save_json_to_excel(self, file_path_json: Path = "outputs/book_data.json", file_path_xlsx: Path = "outputs/book_data.xlsx", sheet_name: str = "Book Data") -> None:
